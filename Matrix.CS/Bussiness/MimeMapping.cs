...
namespace Matrix.CS
{
    public class MimeMapping
    {
        ...
        static MimeMapping()
        {
            MimeMapping._mimeMappingTable = new Hashtable(200, StringComparer.CurrentCultureIgnoreCase);
            ...
            MimeMapping.AddMimeMapping(".flv", "video/x-flv");
            MimeMapping.AddMimeMapping(".f4v", "video/x-flv");
