...
namespace Matrix.DataEntity
{
    public class MariaDBHelper
    {
        ...
        /// <returns></returns>
        public static string GetData(MySqlDataReader reader, string index)
        {
        ...
        /// <returns></returns>
        public delegate void readData(MySqlDataReader reader);
        ...
        public static void ExecuteReader(String cmdText, CommandType cmdType, readData callback, params MySqlParameter[] parameters)
        {
            using (MySqlConnection conn = new MySqlConnection(strDataBaseCon))
            {
        ...
        public static int ExecuteNonQuery(String cmdText, CommandType cmdType, params MySqlParameter[] parameters)
        {
            using (MySqlConnection conn = new MySqlConnection(strDataBaseCon))
            {
                using (MySqlCommand cmd = new MySqlCommand(cmdText, conn))
        ...
        public static object ExecuteScalar(String cmdText, CommandType cmdType, params MySqlParameter[] parameters)
        {
            using (MySqlConnection conn = new MySqlConnection(strDataBaseCon))
            {
                using (MySqlCommand cmd = new MySqlCommand(cmdText, conn))
